...
public class MockBackendDataLoader implements PredictivePrefetcher.DataLoader {
    ...
    /**
     * Creates a mock backend with default settings (10K keys, 10-50ms latency, 0% failure).
     */
    public MockBackendDataLoader() {
        this(10000, 10, 50, 0.0);
    }
    ...
    private String generateKey(int index) {
        ...
        switch (category) {
            case 0: return "user:" + index;
            case 1: return "product:" + index;
            case 2: return "session:" + index;
            case 3: return "order:" + index;
    ...
    private byte[] generateData(String key, Random random) {
        ...
        String data = String.format(
            ...
            generateRandomString(random, 50, 200)
        );
